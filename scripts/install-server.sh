#!/usr/bin/env bash
# install-server.sh — Set up the Rocket standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  Rocket Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  ROCKET_SERVER_TOKEN=$TOKEN \\"
echo "  ROCKET_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ROCKET_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  ROCKET_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ROCKET_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ROCKET_RPC_HOST=0.0.0.0 \\"
echo "  ROCKET_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  ROCKET_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  ROCKET_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  ROCKET_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  ROCKET_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
