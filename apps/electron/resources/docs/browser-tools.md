...
Use `browser_tool` to control built-in browser windows (Chromium) inside Rocket.
...
- Before first browser tool usage, the agent must read this guide (`~/.rocket/docs/browser-tools.md`).
