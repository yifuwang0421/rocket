...
export default [
  ...
  // TypeScript/React files
  {
    ...
    plugins: {
      ...
      // Custom plugin for Rocket rules
      'rocket': {
        rules: {
    ...
    rules: {
      ...
      // Custom Rocket rules
      'rocket/no-direct-navigation-state': 'error',
      'rocket/no-localstorage': 'warn',
  ...
  // Enforce backend abstraction boundary in Electron main process.
  {
    ...
    rules: {
      'no-restricted-imports': ['error', {
        paths: [
          {
            name: '@rocket/shared/codex',
            message: 'Use provider-agnostic APIs from @rocket/shared/agent/backend instead.',
          },
          {
            name: '@rocket/shared/agent/claude-agent',
            message: 'Provider backends must stay behind @rocket/shared/agent/backend.',
          },
          {
            name: '@rocket/shared/agent/pi-agent',
            message: 'Provider backends must stay behind @rocket/shared/agent/backend.',
          },
        ],
      }],
      ...
      'no-restricted-syntax': ['error',
        {
          ...
          message: 'Do not call provider APIs directly in Electron model fetchers. Delegate to fetchBackendModels() from @rocket/shared/agent/backend.',
        },
        {
