...
const EXPECTED_CHANNELS: string[] = [
  ...
  'drafts:getAll',
  'drafts:set',
  'file:createWorkspaceMarkdown',
  'file:generateThumbnail',
  'file:getWorkspaceAgentContext',
  ...
  'file:readWorkspaceMarkdown',
  'file:readWorkspacePreview',
  'file:rebuildWorkspaceResearchIndex',
  'file:saveWorkspaceMarkdown',
  'file:searchWorkspaceResearch',
  ...
  'researchScope:createFolderEntry',
  'researchScope:get',
  'researchScope:importToFolder',
  'researchScope:listFolder',
  'researchScope:removeSector',
  'researchScope:removeWatchlist',
  'researchScope:searchStocks',
  'researchScope:upsertSector',
  'researchScope:upsertWatchlist',
  'resources:export',
  'resources:import',
  'rtk:getEnabled',
  'rtk:getGain',
