...
import { getNetworkProxySettings, setNetworkProxySettings } from '@rocket/shared/config/storage';
import type { NetworkProxySettings } from '@rocket/shared/config/types';
