 ...
 * electron-updater library. Updates are served from https://agents.rocket.app/electron/latest
...
import { getAppVersion } from '@rocket/shared/version'
import {
  getDismissedUpdateVersion,
  clearDismissedUpdateVersion,
} from '@rocket/shared/config'
import { readJsonFileSync } from '@rocket/shared/utils/files'
