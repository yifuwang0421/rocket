...
const WRAPPER_COMMANDS_TURN: ActivityItem[] = [
  ...
  { id: 'wrapper-fill', type: 'tool', status: 'completed', toolName: 'browser_tool', toolInput: { command: 'fill @e5 hello@rocket.app' }, intent: 'Wrapper: fill text field', timestamp: now - 3300 },
...
function BrowserAgentEmptyState({
  ...
  const handlePromptSelect = useCallback(async (prompt: string) => {
    ...
    const deepLinkUrl = `rocket://${deepLinkRoute}`
...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  default: [
    ...
    {
      id: 'mock-4',
      url: 'https://github.com/rocket/rockets-oss',
      title: 'GitHub',
      favicon: null,
      isLoading: false,
      canGoBack: true,
  ...
  'long-names': [
    {
      ...
      title: 'Rocket Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'many-running': [
    ...
    {
      id: 'run-3',
      url: 'https://github.com/rocket/rockets-oss/pulls',
      title: 'GitHub PRs',
      favicon: null,
      isLoading: true,
      canGoBack: false,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/rocket/rockets-oss',
      title: 'Rocket OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
