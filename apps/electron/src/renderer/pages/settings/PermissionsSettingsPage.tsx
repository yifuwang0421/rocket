 ...
 * Shows both default patterns (from ~/.rocket/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.rocket/permissions/default.json.
...
import { type PermissionsConfigFile } from '@rocket/shared/agent/modes'
import {
...
import { getDocUrl } from '@rocket/shared/docs/doc-links'
...
/**
 * Build default permissions data from ~/.rocket/permissions/default.json.
