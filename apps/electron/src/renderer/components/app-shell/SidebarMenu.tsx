...
import { getDocUrl, type DocFeature } from '@rocket/shared/docs/doc-links'
...
export function SidebarMenu({
  ...
  if (type === 'newSession') {
    return (
      <MenuItem onClick={() => window.electronAPI.openUrl('rocket://action/new-session?window=focused')}>
