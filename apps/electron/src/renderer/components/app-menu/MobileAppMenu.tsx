...
import { RocketSymbol } from '../icons/RocketSymbol'
...
/**
 * Mobile AppMenu — Rocket logo trigger that opens a full-screen, navigation-stack sheet.
 *
...
export function MobileAppMenu(props: AppMenuProps) {
  ...
  return (
    <>
      ...
      >
        <RocketSymbol className="!h-5 !w-auto text-accent" />
      </TopBarButton>
      <MobileMenuSheet
        state={state}
        pages={pages}
