...
import type { ContentBadge } from '@rocket/core'
...
import { parseMentions, stripAllMentions, resolveSkillMentions, resolveSourceMentions, type ParsedMentions } from '@rocket/shared/mentions'
