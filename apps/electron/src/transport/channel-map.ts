...
export const CHANNEL_MAP = {
  ...
  listWorkspaceFiles: invoke(RPC_CHANNELS.file.LIST_WORKSPACE_FILES),
  readWorkspaceMarkdown: invoke(RPC_CHANNELS.file.READ_WORKSPACE_MARKDOWN),
  readWorkspacePreview: invoke(RPC_CHANNELS.file.READ_WORKSPACE_PREVIEW),
  getWorkspaceAgentContext: invoke(RPC_CHANNELS.file.GET_WORKSPACE_AGENT_CONTEXT),
  searchWorkspaceResearch: invoke(RPC_CHANNELS.file.SEARCH_WORKSPACE_RESEARCH),
  rebuildWorkspaceResearchIndex: invoke(RPC_CHANNELS.file.REBUILD_WORKSPACE_RESEARCH_INDEX),
  saveWorkspaceMarkdown: invoke(RPC_CHANNELS.file.SAVE_WORKSPACE_MARKDOWN),
  createWorkspaceMarkdown: invoke(RPC_CHANNELS.file.CREATE_WORKSPACE_MARKDOWN),
  importToWorkspace: invoke(RPC_CHANNELS.file.IMPORT_TO_WORKSPACE),
  ...
  // Workspace research scope
  getWorkspaceResearchScope: invoke(RPC_CHANNELS.researchScope.GET),
  searchStockSuggestions: invoke(RPC_CHANNELS.researchScope.SEARCH_STOCKS),
  listWorkspaceResearchScopeFolder: invoke(RPC_CHANNELS.researchScope.LIST_FOLDER),
  createWorkspaceResearchScopeFolderEntry: invoke(RPC_CHANNELS.researchScope.CREATE_FOLDER_ENTRY),
  importToWorkspaceResearchScopeFolder: invoke(RPC_CHANNELS.researchScope.IMPORT_TO_FOLDER),
  upsertWorkspaceWatchlistItem: invoke(RPC_CHANNELS.researchScope.UPSERT_WATCHLIST),
  removeWorkspaceWatchlistItem: invoke(RPC_CHANNELS.researchScope.REMOVE_WATCHLIST),
  upsertWorkspaceSectorItem: invoke(RPC_CHANNELS.researchScope.UPSERT_SECTOR),
  removeWorkspaceSectorItem: invoke(RPC_CHANNELS.researchScope.REMOVE_SECTOR),
