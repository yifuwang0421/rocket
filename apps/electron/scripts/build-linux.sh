...
echo "=== Building Rocket AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Rocket-x86_64.AppImage or Rocket-aarch64.AppImage
BUILT_APPIMAGE_NAME="Rocket-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Rocket-x64.AppImage, Rocket-arm64.AppImage
APPIMAGE_NAME="Rocket-${ARCH}.AppImage"
