...
export const RPC_CHANNELS = {
  ...
  file: {
    CREATE_WORKSPACE_MARKDOWN: 'file:createWorkspaceMarkdown',
    IMPORT_TO_WORKSPACE: 'file:importToWorkspace',
    LIST_WORKSPACE_FILES: 'file:listWorkspaceFiles',
    READ: 'file:read',
    ...
    READ_WORKSPACE_PREVIEW: 'file:readWorkspacePreview',
    GET_WORKSPACE_AGENT_CONTEXT: 'file:getWorkspaceAgentContext',
    SEARCH_WORKSPACE_RESEARCH: 'file:searchWorkspaceResearch',
    REBUILD_WORKSPACE_RESEARCH_INDEX: 'file:rebuildWorkspaceResearchIndex',
    STORE_ATTACHMENT: 'file:storeAttachment',
    READ_WORKSPACE_MARKDOWN: 'file:readWorkspaceMarkdown',
    SAVE_WORKSPACE_MARKDOWN: 'file:saveWorkspaceMarkdown',
    GENERATE_THUMBNAIL: 'file:generateThumbnail',
  },
  researchScope: {
    GET: 'researchScope:get',
    SEARCH_STOCKS: 'researchScope:searchStocks',
    LIST_FOLDER: 'researchScope:listFolder',
    CREATE_FOLDER_ENTRY: 'researchScope:createFolderEntry',
    IMPORT_TO_FOLDER: 'researchScope:importToFolder',
    UPSERT_WATCHLIST: 'researchScope:upsertWatchlist',
    REMOVE_WATCHLIST: 'researchScope:removeWatchlist',
    UPSERT_SECTOR: 'researchScope:upsertSector',
    REMOVE_SECTOR: 'researchScope:removeSector',
  },
  fs: {
    SEARCH: 'fs:search',
