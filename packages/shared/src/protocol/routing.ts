...
export const REMOTE_ELIGIBLE_CHANNELS = new Set<string>([
  ...
  // researchScope — Workspace-owned company/industry metadata and folders
  RPC_CHANNELS.researchScope.GET,
  RPC_CHANNELS.researchScope.SEARCH_STOCKS,
  RPC_CHANNELS.researchScope.LIST_FOLDER,
  RPC_CHANNELS.researchScope.CREATE_FOLDER_ENTRY,
  RPC_CHANNELS.researchScope.IMPORT_TO_FOLDER,
  RPC_CHANNELS.researchScope.UPSERT_WATCHLIST,
  RPC_CHANNELS.researchScope.REMOVE_WATCHLIST,
  RPC_CHANNELS.researchScope.UPSERT_SECTOR,
  RPC_CHANNELS.researchScope.REMOVE_SECTOR,
