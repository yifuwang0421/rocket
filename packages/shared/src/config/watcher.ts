 ...
 *
 * Watched paths:
 * - ~/.rocket/config.json - Main app configuration
 * - ~/.rocket/preferences.json - User preferences
 * - ~/.rocket/theme.json - App-level theme overrides
 * - ~/.rocket/themes/*.json - Preset theme files (app-level)
 * - ~/.rocket/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.rocket/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.rocket/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.rocket/permissions/)
