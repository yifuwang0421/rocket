 ...
 * Guides are now served exclusively via the rockets-docs MCP server.
 *
 ...
 * Use the rockets-docs MCP server to search for setup guides.
 *
 * Example: mcp__rockets-docs__SearchCraftAgents({ query: "github source setup guide" })
 */
