 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.rocket/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.rocket/release-notes/
  // (Docker/remote server may not have ROCKET_BUNDLED_ASSETS_ROOT set,
