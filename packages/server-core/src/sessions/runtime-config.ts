import type { AgentProvider, LlmAuthType } from '@rocket/shared/agent/backend'
import { isCompatProvider, modelSupportsImages, type LlmConnection } from '@rocket/shared/config'
