...
We take security seriously. If you discover a security vulnerability in Rocket, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, contact the Rocket maintainers privately through the repository hosting platform.
...
- The Rocket desktop application
- The `@rocket/*` workspace packages
- Official Rocket repositories
